...
/* SETUP */
	$set_email_to = "hello@email.be"; //Het email waar de mail naar verzonden wordt.
...
/* ======================================================================================================================= */
	...
	$givenMessage = str_replace('<br />', PHP_EOL, $givenMessage);
	
	$set_email_sender = $givenEmail;
	
	if(isset($givenName) && isset($givenMessage) /*&& isset($givenSubject)*/ && isset($givenEmail)){
		$to = $set_email_to; /* "iemand@site.be, ander@site.be"; voor meerdere emails */
		$subject = $set_email_subject;
		...
		// More headers
		$headers .= 'From: <'.$set_email_sender.'>' . "\r\n";
		$headers .= 'Cc: '.$givenEmail.'' . "\r\n";
